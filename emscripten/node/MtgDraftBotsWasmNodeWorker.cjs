...
var createMtgDraftBots = (function() {
  var _scriptDir = typeof document !== 'undefined' && document.currentScript ? document.currentScript.src : undefined;
  if (typeof __filename !== 'undefined') _scriptDir = _scriptDir || __filename;
  return (
function(createMtgDraftBots) {
  createMtgDraftBots = createMtgDraftBots || {};
...
var Module = typeof createMtgDraftBots !== 'undefined' ? createMtgDraftBots : {};
...
var INITIAL_MEMORY = Module['INITIAL_MEMORY'] || 39976960;
...
assert(INITIAL_MEMORY == 39976960, 'Detected runtime INITIAL_MEMORY setting.  Use -s IMPORTED_MEMORY to define wasmMemory dynamically');
...
var wasmBinaryFile;
  wasmBinaryFile = 'MtgDraftBotsWasmNodeWorker.wasm';
...
function createWasm() {
  ...
  function receiveInstance(instance, module) {
    ...
    //assert(wasmMemory.buffer.byteLength === 39976960);
...
run();
  ...
  return createMtgDraftBots.ready
}
);
})();
if (typeof exports === 'object' && typeof module === 'object')
  module.exports = createMtgDraftBots;
else if (typeof define === 'function' && define['amd'])
  define([], function() { return createMtgDraftBots; });
else if (typeof exports === 'object')
  exports["createMtgDraftBots"] = createMtgDraftBots;
